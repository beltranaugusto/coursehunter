...
Revision ID: 922b67b7d9e4
Revises: 
Create Date: 2023-02-18 20:21:35.054365
...
def upgrade():
    ...
    sa.Column('creationDate', sa.DateTime(timezone=True), server_default='2023-02-18 20:21:34.605314', nullable=True),
